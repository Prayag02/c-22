...
function setup() {
	...
	bob1 = Bodies.circle(400,400,40,bob_options);
	World.add(world,bob1);

	bob2 = Bodies.circle(355,400,40,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(395,400,40,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(435,400,40,bob_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(475,400,40,bob_options);
